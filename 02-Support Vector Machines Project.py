...
# ** Create a pairplot of the data set. Which flower species seems to be the most separable?** Setosa
...
x_train, x_test, y_train, y_test =train_test_split(dff.drop('species', axis=1), dff['species'], test_size = 0.3, random_state = 101)
...
# In[57]:
param_grid = {'C':[1, 0.1, 10, 100, 1000], 'gamma':[1, 0.1, 0.001, 0.01, 0.0001]}
